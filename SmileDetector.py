# -*- coding: utf-8 -*-
"""
Created on Sat Feb 16 14:20:23 2019
...
#Getting cascades of eyes
eye_cascade  = cv2.CascadeClassifier('haarcascade_eye.xml')

#Getting cascades of smile
...
def detect(frame,gray):
    ...
    for (x,y,w,h) in faces:
        ...
        #Smile can be found inside the face so selectiong inside part of face to detect the eyes inside it.   
